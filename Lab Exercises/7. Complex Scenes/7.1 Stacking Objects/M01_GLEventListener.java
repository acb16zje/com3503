...
public class M01_GLEventListener implements GLEventListener {
  ...
  public void initialise(GL3 gl) {
    ...
    float sphere2Height = 6f;  // *** added variable to make subsequent calculations easier
    // no texture for this sphere
    ...
    modelMatrix = Mat4.multiply(Mat4Transform.scale(1f,sphere2Height,1f), Mat4Transform.translate(0,0.5f,0));
    // *** This is the important bit. The object sphere2 needs to be translated to the top of both previous objects.
    // With scene graphs, we shall see that it is much easier to do this kind of thing as we only need to consider the parent object
    // not all ancestors (since the parent will already have considred its parent, etc). This is explained more in lectures.
