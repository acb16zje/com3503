...
public class M03_GLEventListener implements GLEventListener {
  ...
  private TransformNode translateX, rotateAll, rotateUpper, rotateTop, rotateUpperBy60, rotateTopBackTo0, rotateUpsideDown;
  private float xPosition = 0;
  private float rotateAllAngleStart = 25, rotateAllAngle = rotateAllAngleStart;
  private float rotateUpperAngleStart = -15, rotateUpperAngle = rotateUpperAngleStart;
  private float rotateTopAngleStart = -10, rotateTopAngle = rotateTopAngleStart;
  ...
  private void initialise(GL3 gl) {
    ...
    translateX = new TransformNode("translate("+xPosition+",10,0)", Mat4Transform.translate(xPosition,10,0));
    rotateAll = new TransformNode("rotateAroundZ("+rotateAllAngle+")", Mat4Transform.rotateAroundZ(rotateAllAngle));
    rotateUpsideDown = new TransformNode("rotateAroundZ(180)",Mat4Transform.rotateAroundZ(180));
    ...
    rotateUpperBy60 = new TransformNode("rotateAroundZ(60)",Mat4Transform.rotateAroundZ(60));
    ...
    NameNode upperSideBranch = new NameNode("upper side branch");
    m = Mat4Transform.rotateAroundZ(-60);
    m = Mat4.multiply(m, Mat4Transform.scale(1.4f,3.1f,1.4f));
    m = Mat4.multiply(m, Mat4Transform.translate(0,0.5f,0));
    TransformNode makeUpperSideBranch = new TransformNode("scale(1.4f,3.1f,1.4f);translate(0,0.5,0)", m);
    ModelNode cube1SideNode = new ModelNode("Sphere(3)", sphere);

    TransformNode translateToMostTop = new TransformNode("translate(0,3.1f,0)",Mat4Transform.translate(0,3.1f,0));
    rotateTop = new TransformNode("rotateAroundZ("+rotateTopAngle+")",Mat4Transform.rotateAroundZ(rotateTopAngle));
    rotateTopBackTo0 = new TransformNode("rotateAroundZ(-60)",Mat4Transform.rotateAroundZ(-60));
    NameNode topBranch = new NameNode("top branch");
    m = Mat4Transform.scale(1.8f,4.1f,1.8f);
    m = Mat4.multiply(m, Mat4Transform.translate(0,0.5f,0));
    TransformNode makeTopBranch = new TransformNode("scale(1.8f,4.1f,1.8f);translate(0,0.5,0)", m);
    ModelNode cube2Node = new ModelNode("Sphere(2)", sphere);

    twoBranchRoot.addChild(translateX);
      translateX.addChild(rotateAll);
        rotateAll.addChild(rotateUpsideDown);
          rotateUpsideDown.addChild(lowerBranch);
            ...
            lowerBranch.addChild(translateToTop);
              translateToTop.addChild(rotateUpper);
                rotateUpper.addChild(rotateUpperBy60);
                  rotateUpperBy60.addChild(upperBranch);
                    upperBranch.addChild(makeUpperBranch);
                      makeUpperBranch.addChild(cube1Node);
            lowerBranch.addChild(translateToTop);
              translateToTop.addChild(rotateUpper);
                rotateUpper.addChild(upperSideBranch);
                  upperSideBranch.addChild(makeUpperSideBranch);
                    makeUpperSideBranch.addChild(cube1SideNode);
                  upperBranch.addChild(translateToMostTop);
                    translateToMostTop.addChild(rotateTop);
                      rotateTop.addChild(rotateTopBackTo0);
                        rotateTopBackTo0.addChild(topBranch);
                          topBranch.addChild(makeTopBranch);
                            makeTopBranch.addChild(cube2Node);
  ...
  private void updateBranches() {
    ...
    rotateTopAngle = rotateTopAngleStart*(float)Math.sin(elapsedTime*0.9f);
    rotateAll.setTransform(Mat4Transform.rotateAroundZ(rotateAllAngle));
    rotateUpper.setTransform(Mat4Transform.rotateAroundZ(rotateUpperAngle));
    rotateTop.setTransform(Mat4Transform.rotateAroundZ(rotateTopAngle));
