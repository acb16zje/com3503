...
public class S04_GLEventListener implements GLEventListener {
  ...
  public void render(GL3 gl) {
    ...
    replaceVBO_XYZ(gl, 1, (float)Math.sin(elapsedTime)*0.7f, (float)Math.cos(elapsedTime)*0.7f,0);
    replaceVBO_XYZ(gl, 2, (float)Math.cos(elapsedTime*1.5), (float)Math.sin(elapsedTime*1.5),0);
